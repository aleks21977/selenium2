...
public class DZ17 extends TestBase {
    ...
    public void dz17Test() {
        ...
        //******получаем Id карневой категории


        //******получаем Id товаров карневой категории
//        ArrayList<String> goodsIdsWithRoot = new ArrayList<String>();
//        for (WebElement goodsCategory : listGoodsRootCategories) {
//            String hrefGoods = goodsCategory.getAttribute("href");
//            goodsIdsWithRoot.add(substringAfter(hrefGoods, "product_id="));
//        }
//        //System.out.println(goodsIds);
//
//        //***********прокликиваем все товары подкатегории
//        for (String goodsId : goodsIdsWithRoot) {
//            driver.findElement(By.xpath("//a[@href[contains(.,'category_id=" + categoryId + "&product_id=" + goodsId + "')]]")).click();
//            try { Thread.sleep(1000); } catch (Exception e) { }//пауза
//            //***********проверяем что на консоль ничего не выодится
//            driver.manage().logs().get("browser").forEach(l -> System.out.println(l));
